...
%
%We first sum count with each possible number of pairs of t which are equal. Then the rest of factors will be equal due to t1+a=t2+b, thus t1-t2=fixed. since if t1+a=t2+ainvolved, means counted already. thus chain forms due to pairing of even one opposite c. which means out of bounds t.
\begin{comment}
